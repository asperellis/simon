...
const API = {
  ...
  getSearchSuggestions: query => {
    ...
    return fetch(
      `${
        config.apiUrl
      }/search/GetMainSearchAutoCompleteWithType?q=${query}&max=50&hasWebsiteOnly=false&validPreferredMallsOnly=false&returnType=All&key=40A6F8C3-3678-410D-86A5-BAEE2804C8F2/`
    )
